...
if __name__ == '__main__':
    ...
    parser.add_argument("--features_folder", default="N", type=str, help="path to features for each patient if T or N default folders are used")
    ...
    parser.add_argument("--results_folder_name", type=str, default="baseline", help="Folder name for all files written.")
